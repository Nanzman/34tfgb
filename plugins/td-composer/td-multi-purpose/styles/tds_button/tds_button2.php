...
class tds_button2 extends td_style {
    ...
    private function get_css() {
		...
		$raw_css =
			"<style>
				...
				body .$style_selector:hover:after {
					opacity: 1;
				}
				/* @" . $style_atts_prefix . "background_active_solid$style_atts_uid */
				body $unique_block_active_class:after {
					background-color: @" . $style_atts_prefix . "background_active_solid$style_atts_uid;
				}
    ...
    static function cssMedia( $res_ctx ) {
        ...
        $border_size = $border_size != '' ? $border_size : '2px';
        ...
        // border color
        $res_ctx->load_color_settings( 'border_color', $style_atts_prefix . 'border_color_solid' . $style_atts_uid, $style_atts_prefix . 'border_color_gradient' . $style_atts_uid, $style_atts_prefix . 'border_color_gradient_1' . $style_atts_uid, $style_atts_prefix . 'border_color_params' . $style_atts_uid, __CLASS__ );
