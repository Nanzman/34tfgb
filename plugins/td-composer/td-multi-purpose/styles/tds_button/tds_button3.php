...
class tds_button3 extends td_style {
    ...
    static function cssMedia( $res_ctx ) {
        ...
        /*-- SHADOW -- */
        $res_ctx->load_shadow_settings( 16, 0, 2, 0, 'rgba(0, 0, 0, 0.1)', 'shadow', __CLASS__, false, $style_atts_prefix, $style_atts_uid );
        $res_ctx->load_shadow_settings( 26, 0, 2, 0, 'rgba(0, 0, 0, 0.1)', 'shadow_hover', __CLASS__, false, $style_atts_prefix, $style_atts_uid );
        if( $scroll_to_class != '' ) {
