...
class td_panel_generator {
    ...
    static function dropdown($params_array) {
        $select_field = '';
        $class_button = !empty($params_array['class']) ? $params_array[ 'class' ] : '';

        //check for user saved data
        $user_data = td_panel_data_source::read($params_array);

        $select_field = '<div class="td-select-style-overwrite ' . $class_button . ' ">
    ...
    */
    ...
    static function upload_image($params_array) {
        ...
        if(!empty($control_value)){
            ...
            $image_path = TDC_URL_LEGACY_COMMON . '/wp_booster/wp-admin/images/panel/no_img_upload.png';
        }
...
//            or $params_array['ds'] == 'td_fonts_mob'
     ...
     *  array('text' => '', 'title' => '', 'val' => '', 'img' => TDC_PATH_LEGACY_COMMON . '/wp_booster/wp-admin/images/panel/module-default.png')
     */
        ...
        switch ($view_name) {
            case 'default+enabled_on_loops':
                ...
                $modules_array[] = array(
	                ...
	                'val' => '',
	                'img' => TDC_URL_LEGACY_COMMON . '/wp_booster/wp-admin/images/panel/module-default.png'
                );
