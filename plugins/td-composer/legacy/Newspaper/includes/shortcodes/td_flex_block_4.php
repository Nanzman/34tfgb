    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
                ...
                /* @fav_size2 */
                body .$unique_block_class .td_module_flex_4 .td-favorite {
                    font-size: @fav_size2;
                }
                /* @fav_space2 */
                body .$unique_block_class .td_module_flex_4 .td-favorite {
				...
				/* @fav_ico_color2 */
                body .$unique_block_class .td_module_flex_4 .td-favorite svg {
                    fill: @fav_ico_color2;
                }
                /* @fav_ico_color_h2 */
                body .$unique_block_class .td_module_flex_4 .td-favorite:hover svg {
                ...
                /* @fav_bg_h2 */
                body .$unique_block_class .td_module_flex_4 .td-favorite:hover {
