...
?>
	...
	<div id="tdc-sidebar" class="tdc-sidebar-inline">
		<div class="tdc-top-buttons">
            ...
            <a class="tdc-header-link tdc-save-page <?php echo ( $enableSaveDropdown ? 'tdc-header-link-dropdown ' : '' ) . $save_btn_class; ?>" href="#" title="Save the page content CTRL + S">
                <span class="tdc-sidebar-icon tdc-icon-save"></span>
                <span class="tdc-header-label tdc-text-save">Save</span>

                <?php if( 'Newspaper' === TD_THEME_NAME && defined( 'TD_CLOUD_LIBRARY' ) && $enableSaveDropdown ) { ?>
                    <span class="tdc-header-link-sub-menu" title="">
                        <span class="tdc-header-link-sub-menu-item tdc-save-all">Save all</span>
                    ...
                    if ( 'module' === $tdbTemplateType ) {
						...
						if( !empty( $common_page_el_mapped_shortcodes ) ) {
		                    ...
		                    foreach ( $common_page_el_mapped_shortcodes as $mapped_shortcode ) {
								...
								if( $mapped_shortcode['base'] === 'tdb_single_custom_field' ) {
						...
						if ( !empty( $multipurpose_mapped_shortcodes ) ) {
		                    ...
		                    foreach ( $multipurpose_mapped_shortcodes as $mapped_shortcode ) {
								...
								if( 
									...
									$mapped_shortcode['base'] === 'tdm_block_column_title' ||
									$mapped_shortcode['base'] === 'tdm_block_icon' ||
									$mapped_shortcode['base'] === 'tdm_block_inline_text' ||
									$mapped_shortcode['base'] === 'tdm_block_list' ||
									$mapped_shortcode['base'] === 'tdm_block_inline_image'
								) {
