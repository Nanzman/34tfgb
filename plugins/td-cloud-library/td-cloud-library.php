...
Author: tagDiv
Version: 2.7 | built on 18.05.2023 11:25
...
//hash
define('TD_CLOUD_LIBRARY', 'ec3d2d0202aa1c6516855c14ff9ec3ea');
...
add_action('tdc_welcome_panel_text', function() {
    if (tdc_util::get_get_val('tdbTemplateType') !== false) {
        ...
        <?php if ( td_util::get_option('td_banners_status') !== 'off' ) { ?>
            <a class="td-services-link" href="https://tagdiv.com/submit-a-request/?utm_source=tdc&utm_medium=banner&utm_campaign=custom_work&utm_content=start_screen" title="Get free quote" target="_blank">
                <img style="margin-top:20px; border-radius: 3px;" class="td-services-img" alt="" src="https://cloud.tagdiv.com/services-img/banner-composer.png">
            </a>
        <?php
        }
    }
